...
namespace VsCSharpWinForm_sample2.Views
{
    public partial class FrmTicTacToe : Form
    {
        ...
        //private static Dictionary<int, string> PlayingModes = new Dictionary<int, string>()
        //{
        //    {0, "Two Players"},
        //    {1, "Vs Computer" }
        //};
        ...
        private List<int> MarkList = new List<int>();
        ...
        private void FrmTicTacToe_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Dictionary<GameMode, string> cbxDist = new Dictionary<GameMode, string>();
                foreach (GameMode i in Enum.GetValues(typeof(GameMode)))// cbxDist.Add(i, Enum.GetName(typeof(PlayingMode), i));
                    cbxDist.Add(i, Helpers.EnumExtensionMethods.GetEnumDescription(i));
        ...
        private void NumberLabel_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (!int.TryParse((sender as Label).Text, out int index))
                {
                    Logger?.Warn("Cannot parse to integer. {0}", (sender as Label).Text);
                    return;
                }
                int indexm1 = index - 1;
        ...
        private void BtnRestartGame_Click(object sender, EventArgs e) { InitializeGame(); }

        private void CbxMode_SelectedIndexChanged(object sender, EventArgs e) { InitializeGame(); }
        ...
        private void TxtLog_KeyUp(object sender, KeyEventArgs e) { KeyboardAction(e.KeyCode); }

        private void CbxMode_KeyUp(object sender, KeyEventArgs e) { KeyboardAction(e.KeyCode); }

        private void BtnRestartGame_KeyUp(object sender, KeyEventArgs e) { KeyboardAction(e.KeyCode); }
